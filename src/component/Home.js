        ...
        <div className="home__main">
          ...
          <div className="home__name">
            ...
            <div className="home__description">
              I am an Student,Web Developer based in Tokyo.Born in Tokyo.I'm in Yokohama National University.designer. Branding, Art Direction, Design, Planning, Development
            </div>
          </div>
        </div>
      </div>
